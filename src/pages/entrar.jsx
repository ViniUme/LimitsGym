...
export default function Login(props){
    ...
    if((message != 'loading') && (props.cookies.USER_LOGIN == undefined)){
        return(
            <Page title='Entre com sua conta na Limits Gym' description='Tela para acessar a conta do cliente da academia' cookies={props.cookies} name={props.data.name} link="login">
