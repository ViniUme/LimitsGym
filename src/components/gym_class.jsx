...
export default function GymClass({cookies}){
    ...
    return (
        <div className={style.gym_class}>
            ...
            <div className={style.body}>
                ...
                <Link href={ReturnLink()}><a className={style.link_join}><button className={style.button_join}>Junte-se agora</button></a></Link>
            </div>
