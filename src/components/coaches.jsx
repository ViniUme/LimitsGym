        ...
        <section className={styles.coaches_section}>
            ...
            <Link href="https://www.instagram.com/gabrieltardivo/"><a target="_blank" className={styles.img_div}>
                ...
                <div className={styles.coache_text}>
                    ...
                    <a className={styles.insta}><InstagramIcon className={styles.image}/> <span className={styles.insta_id}>gabrieltardivo</span></a>
                </div>
            </a></Link>
            <Link href="https://www.instagram.com/maaxmarlon/"><a target="_blank" className={styles.img_div}>
                ...
                <div className={styles.coache_text}>
                    ...
                    <a className={styles.insta}><InstagramIcon className={styles.image}/> <span className={styles.insta_id}>maaxmarlon</span></a>
                </div>
            </a></Link>
            <Link href="https://www.instagram.com/treinador_kasa/"><a target="_blank" className={styles.img_div}>
                ...
                <div className={styles.coache_text}>
                    ...
                    <a className={styles.insta}><InstagramIcon className={styles.image}/> <span className={styles.insta_id}>treinador_kasa</span></a>
                </div>
            </a></Link>
            <Link href="https://www.instagram.com/julianocruz889/"><a target="_blank" className={styles.img_div}>
                ...
                <div className={styles.coache_text}>
                    ...
                    <a className={styles.insta}><InstagramIcon className={styles.image}/> <span className={styles.insta_id}>julianocruz889</span></a>
                </div>
            </a></Link>
        </section>
    )
